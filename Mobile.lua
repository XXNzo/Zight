...
local Window = OrionLib:MakeWindow({Name = "Zight Hub", HidePremium = false, IntroText = "Zight Library", SaveConfig = true, ConfigFolder = "Zight Hub"})
----------Tab-----------------------
...
elseif World3 then
	tableBoss = {"Zight Hub Raid Boss [Lv. 3000]","Stone","Island Empress","Kilo Admiral","Captain Elephant","Beautiful Pirate","rip_indra True Form","Longma","Soul Reaper","Cake Queen"}
end
        ...
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Zight Hub Hub(Noitification)",
